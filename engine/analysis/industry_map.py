...
# ── 한국: 네이버 업종(77) → 산업군 ─────────────────────────────────────
KR_SECTORS = {
    "semi": ["반도체와반도체장비", "디스플레이장비및부품", "디스플레이패널", "전자장비와기기",
             "전자제품", "컴퓨터와주변기기", "통신장비", "핸드셋", "사무용전자제품"],
    "battery": ["전기장비", "전기제품", "비철금속"],
    "auto": ["자동차", "자동차부품"],
    "bio": ["제약", "생물공학", "생명과학도구및서비스", "건강관리업체및서비스",
            "건강관리장비와용품", "건강관리기술"],
    "ship": ["조선", "해운사", "항공화물운송과물류", "운송인프라", "도로와철도운송", "항공사"],
    "chem": ["화학", "철강", "종이와목재", "포장재"],
    "construct": ["건설", "건축자재", "건축제품", "부동산", "가구"],
    ...
    "defense": ["우주항공과국방", "기계", "상업서비스와공급품", "복합기업"],
...
US_RULES = [
    ...
    ("construct", r"reit|real estate|engineering & construction|building products|"
                  r"residential construction|home improvement"),
    ("ship", r"railroad|marine shipping|airlines|integrated freight|trucking|airport"),
    ...
    ("defense", r"aerospace & defense|farm & heavy construction machinery|specialty industrial|"
...
US_SECTOR_FALLBACK = {
    "기술": "semi", "헬스케어": "bio", "금융": "finance", "산업재": "defense",
    "임의소비재": "consumer", "필수소비재": "consumer", "커뮤니케이션": "internet",
    "에너지": "energy", "유틸리티": "energy", "소재": "chem", "부동산": "construct",
}
